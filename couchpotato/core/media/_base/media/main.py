            ...
            addApiView(
                ...
                docs={
                    ...
                    'params': {
                        'status': {
                            'type': 'array or csv',
                            'desc': f'Filter {media_type}'
                            + ' by status. Example:"active,done"',
                        },
                        'release_status': {
                            'type': 'array or csv',
                            'desc': f'Filter {media_type}'
                            + ' by status of its releases. Example:"snatched,available"',
                        },
                        'limit_offset': {
                            'desc': f'Limit and offset the {media_type}'
                            + ' list. Examples: "50" or "50,30"'
                        },
                        'starts_with': {
                            'desc': 'Starts with these characters. Example: "a" returns all '
                            + media_type
                            + 's starting with the letter "a"'
                        },
